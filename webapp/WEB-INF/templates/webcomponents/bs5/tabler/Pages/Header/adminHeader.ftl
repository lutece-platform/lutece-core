...
<div class="wrapper">
	<header class="navbar navbar-expand-md navbar-dark d-print-none">
		<div class="container-fluid">
			...
			<a href="jsp/site/Portal.jsp" title="#i18n{portal.users.admin_header.title.viewSite} ${site_name}" target="_blank" title="#i18n{portal.site.portal_footer.newWindow}">
				<img src="#dskey{portal.site.site_property.logo_url}" height="30" alt="Tabler" class="navbar-brand-image">
			</a>
							...
							<div class="list-group-item logger">
								<div class="row align-items-start">
									...
									<#assign hasIcon = true />	
										...
										<div class="d-block text-truncate mt-1" title="${logInfo.path!}"><strong>${logInfo.name!}  - ${logInfo.level!}</strong> ${logInfo.path!}</div>
						</#if>
					</#list>
				</#if>
				<#if hasIcon == true >
			...
			<div class="nav-item dropdown">
				...
				<#if admin_logout_url?has_content>
					<a class="dropdown-item" href="${admin_logout_url}" title="#i18n{portal.users.admin_header.deconnectionLink}">
						<i class="fa fa-power-off fa-fw"></i> #i18n{portal.users.admin_header.deconnectionLink}
					</a>
				</#if>
				</div>
			</div>

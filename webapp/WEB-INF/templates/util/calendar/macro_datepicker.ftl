...
<#macro getDatePickerRangeBootstrap language >
    ...
    <div class="input-daterange">
      <div class="col-xs-12 col-sm-4">
        <input type="text" name="date_begin" id="date_begin" value="" class="form-control">
      </div>
      <div class="col-xs-12 col-sm-4">
        <strong>#i18n{labelDateEnd}</strong>
      </div>
      <div class="col-xs-12 col-sm-4">
        <input type="text" name="date_end" id="date_end" value="" class="form-control">
      </div>
    </div>
    -->
 		$('.input-daterange').datepicker({language: "<@getRegional language=language />", autoclose: true});
	});
	</script>
</#macro>

...
<#if nestedPos='after'> <#nested></#if>
<#if target='_blank' && label=''><span class="visually-hidden visually-hidden-focusable"><#if title?has_content>${title!}<#else>${label}</#if> #i18n{portal.theme.newWindowLink}</span></#if>

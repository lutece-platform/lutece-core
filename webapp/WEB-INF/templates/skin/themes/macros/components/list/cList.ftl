...
<#if type ='more'>
    <li class="more">
        <#local paramsAttr1>data-plus="${labelMore}" data-minus="${labelClose}"</#local>
        <@cLink href='#' nestedPos='before' class='btn-more' label=labelMore title=labelMore params=paramsAttr1>

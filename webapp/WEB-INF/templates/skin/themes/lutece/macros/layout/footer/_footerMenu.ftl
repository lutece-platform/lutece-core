...
<#local title=dskey('theme.site_property.Url.legalURLLabel') /><#else><#local title='#i18n{theme.labelLegalInfo}' /></#if>
...
<#local title=dskey('theme.site_property.Url.cguURLLabel') /><#else><#local title='#i18n{theme.labelCgu}' /></#if>
...
<#local title=dskey('theme.site_property.Url.accessibilityLabel') /><#else><#local title='#i18n{theme.labelAccessibility}' /></#if>
...
<#local title=dskey('theme.site_property.Url.wikiURLLabel') /><#else><#local title='#i18n{theme.labelWiki}' /></#if>
...
<#local title=dskey('theme.site_property.Url.dataURLLabel') /><#else><#local title='#i18n{theme.labelDataProtection}' /></#if>
...
<#local title=dskey('theme.site_property.Url.cookieURLLabel') /><#else><#local title='#i18n{theme.labelCookies}' /></#if>

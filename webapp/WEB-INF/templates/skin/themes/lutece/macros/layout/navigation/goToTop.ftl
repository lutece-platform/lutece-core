...
Parameters:
@param - scrollLabel - string - optional -  Nom du menu par défaut - #i18n{theme.gohome} / Haut de page - 
...
-->
<#macro cGoToTop scrollLabel='#i18n{theme.gohome}' scrollClass='primary fadein' scrollBtnClass='btn-gototop' scrollTop=100 deprecated...>

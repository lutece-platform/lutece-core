...
<footer role="contentinfo"<#if params !=''> ${params!}</#if>>
  <div class="container">
     <div class="foot__grid">
        <div>
          <img alt="CiteLibre" style="height:44px;margin-bottom:16px;filter:brightness(0) invert(1);" src="${logoFooter}" />
          <p style="color:rgba(255,255,255,0.7);font-size:14px;line-height:1.6;max-width:320px;">Des services numériques open-source pensés avec et pour les collectivités. Propulsé par Lutèce.</p>
        </div>
        <div><h4>Packs</h4><ul class="footer-menu list-unstyled" aria-label="#i18n{portal.theme.footerInfo}" ><li><a>Service'EZ</a></li><li><a>Rendez-vous</a></li><li><a>Ident'EZ</a></li><li><a>Contact'EZ</a></li></ul></div>
        <div><h4>Ressources</h4><ul class="footer-menu list-unstyled" aria-label="#i18n{portal.theme.footerInfo}" ><li><a>Documentation</a></li><li><a>GitHub</a></li><li><a>Wiki Lutèce</a></li><li><a>Newsletter</a></li></ul></div>
        <div><h4>Legal</h4><ul class="footer-menu list-unstyled" aria-label="#i18n{portal.theme.footerInfo}" ><@_footerMenu /></ul></div>
      </div>
      <div class="foot__legal"><div>© 2026 CiteLIbre · Sous licence EUPL v1.2</div><div>Propulsé par Lutèce · Ville de Paris</div></div>
    </div>
  </div>
  <#--
  <div class="container">

...
- titleAscDesc (optional): an array containing the titles for the ascending and descending sort buttons, respectively. Default values are provided for both.
...
-->
<#macro sort jsp_url attribute id='' titleAscDesc=['#i18n{portal.util.sort.asc}','#i18n{portal.util.sort.desc}'] deprecated...>
...
<@btnGroup ariaLabel='#i18n{portal.util.sort.label}'>
	<@aButton color='action' size='sm' id='sort${id!}_${attribute!}' href='${sort_url}true#sort${id!}_${attribute!}' title='${titleAscDesc[0]!}' buttonIcon='chevron-up' hideTitle=['all'] />
	<@aButton color='action' size='sm' href='${sort_url}false#sort${id!}_${attribute!}' title='${titleAscDesc[1]!}' buttonIcon='chevron-down' hideTitle=['all'] />
</@btnGroup>
</#macro>
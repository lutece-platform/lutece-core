...
<@deprecatedWarning args=deprecated />
<div class="col-md<#if flex> d-md-flex align-items-${valign} justify-content-${align}</#if><#if cols !=''> col-${cols}<#elseif auto> col-md-auto</#if><#if class !=''> ${class}</#if>"<#if id !=''> id="${id}"</#if><#if params !=''> ${params}</#if>>
<#nested>
</div>
</#macro>
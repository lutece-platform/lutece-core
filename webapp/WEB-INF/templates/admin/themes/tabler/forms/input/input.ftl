...
- patternValidationRules (json, optional) : json with id, regex and message to associated with each help controller spans. 
		...
		you can use too an empty string instead of regex. The span will be displayed without validation formatting. example : [{'name':'idSpan1','regex':'','message':'messageSpan1'}]
-->

...
-->
<#macro adminDashboardWidget id title hasHeader=false sm=12 md=4 color='primary' url='' class='' bodyClass='table-responsive no-padding' actions=true actionMenu='' params=''>

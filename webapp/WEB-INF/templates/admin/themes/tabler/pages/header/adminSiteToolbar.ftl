...
<@btnToolbar>
	...
	<@btnGroup class='ms-1 me-2'>
		...
		<@offcanvas id="childpage-properties" title="#i18n{portal.site.admin_page.titleAddChildPage}" targetUrl='jsp/admin/site/AdminSite.jsp?page_id=${page.id}&amp;param_block=5' targetElement='#childpage' btnColor="portet" btnIcon="file-plus me-1" btnTitle="#i18n{portal.site.admin_page.titleAddChildPage}" size="" hideTitle=['all'] redirectForm=false/>
		<@offcanvas id="portlet-type-wrapper" title="#i18n{portal.site.admin_page.labelPortletPage}" btnColor="portet" btnIcon="text-plus" btnTitle="#i18n{portal.site.admin_page.labelPortletPage}" hideTitle=['all'] >
		<@listGroup>
	...
	<@btnGroup class='ms-1'>
		...
		<@button id='iframe-fullscreen' color='info' buttonIcon='maximize' title='#i18n{portal.site.admin_page.labelFullScreen}' hideTitle=['all'] tooltip='#i18n{portal.site.admin_page.labelFullScreen}'/>
	</@btnGroup>  
</@btnToolbar>

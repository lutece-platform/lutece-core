...
document.querySelector("#pageHeader h1").innerHTML = "#i18n{portal.admin.admin_home.welcome}" + " " + document.getElementById("lutece-profile-name").innerText;

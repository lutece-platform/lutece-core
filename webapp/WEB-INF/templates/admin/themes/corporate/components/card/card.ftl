...
-->
<#macro card class='mb-3' id='' headerTitle='' headerClass='bg-info' headerIcon='' status='' statusPos='start' ribbon='' ribbonColor='primary' ribbonPos='top' stamp='' stampColor='primary' params='' deprecated...>
...
<div class="card ${class}"<#if id !=''> id="${id}"</#if>>
	...
	<#if headerTitle !=''><div class="card-header ${headerClass}"><#if headerIcon!=''><@icon style='${headerIcon}' />&#160;</#if>${headerTitle}</div></#if>
	<div class="card-body">
	<#nested>
	</div>
</div>

...
<#if responsive><div class="table-responsive rounded rounded-3 border shadow mb-4"></#if>
<table class="table rounded rounded-3 overflow-hidden border ${class?trim} mb-0" <#if id!=''> id="${id}"</#if><#if params!=''> ${params}</#if>>

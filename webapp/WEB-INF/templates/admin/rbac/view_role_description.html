			...
			<@boxBody>
				<@tform method='post' action='jsp/admin/rbac/DoModifyRole.jsp' name='modify_role'>
				  ...
				  <@formGroup rows=2>
					...
					<@aButton href='jsp/admin/rbac/ViewRoleDescription.jsp?role_key=${role.key}' title='#i18n{portal.admin.message.buttonCancel}' buttonIcon='times' size='' color='secondary' />
				  </@formGroup>
				</@tform>
			</@boxBody>
    </@box>

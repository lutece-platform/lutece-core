					...
					<tbody>
						<#list role_list as role>
						  <tr>
							...
							<td>
								<@aButton href='jsp/admin/rbac/ViewRoleDescription.jsp?role_key=${role.key}' title='#i18n{portal.rbac.view_role_description.labelDescription} (${role.description})' buttonIcon='edit' size='sm' hideTitle=['all']/>
								
								<@aButton href='jsp/admin/rbac/AssignUsersRole.jsp?role_key=${role.key}' title='#i18n{portal.rbac.manage_roles.buttonLabelAssignUsers} (${role.description})' buttonIcon='user' size='sm' hideTitle=['all']/>
								
								<@aButton color='danger' href='jsp/admin/rbac/DoConfirmRemoveRole.jsp?role_key=${role.key}' title='#i18n{portal.rbac.manage_roles.buttonLabelDelete} (${role.description})' buttonIcon='trash' size='sm' hideTitle=['all']/>
							</td>
						  </tr>
						</#list>
					</tbody>

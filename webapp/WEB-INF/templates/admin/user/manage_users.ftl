          ...
          <tr>
            ...
            <td>
				...
				<#if !user.statusAnonymized>
					<@aButton href='jsp/admin/user/AnonymizeAdminUser.jsp?id_user=${user.userId}' title='#i18n{portal.users.actions.labelAnonymize}' buttonIcon='eye-slash' size='sm' hideTitle=['all'] />
				</#if>

<@row>
    <@columns>
        <@box color='success'>
            <@boxHeader title='#i18n{portal.users.create_attribute.pageTitleAttributeRadioButton}' />
			<@boxBody>
				<@tform role='form' action='jsp/admin/user/attribute/DoCreateAttribute.jsp' method='post'>
					...
					<@formGroup helpKey='#i18n{portal.users.create_attribute.labelIsFieldInLineComment}'>
						<@checkBox name='is_field_in_line' id='is_field_in_line' labelKey='#i18n{portal.users.create_attribute.labelIsFieldInLine}' value='1' />
					</@formGroup>
					<@formGroup>

<@row>
	<@columns>
    <@box color='success'>
      <@boxHeader title='#i18n{portal.users.modify_attribute.pageTitleAttributeComboBox}' boxTools=true>
				...
				<@tform action='jsp/admin/user/attribute/DoModifyAttribute.jsp' method='post'>
					...
					<@formGroup helpKey='#i18n{portal.users.create_attribute.labelMultipleComment}'>
						<#list attribute_fields_list as attribute_field>
							...
							<@checkBox name='multiple' id='multiple' labelKey='#i18n{portal.users.create_attribute.labelMultiple}' value='1' checked=checked />
							<#break>
						</#list>
					</@formGroup>
					<@formGroup>
						<@input type='hidden' name='id_attribute' value='${attribute.idAttribute}' />
						<@button type='submit' name='validate' value='validate' buttonIcon='check' title='#i18n{portal.users.create_attribute.buttonValidate}'  size='' hideTitle=['xs'] />
						<@button type='submit' name='apply' value='apply' buttonIcon='check-circle-o' title='#i18n{portal.users.create_attribute.buttonApply}'  size='' hideTitle=['xs'] />
...
<@row>
	<@columns>
		<@box color='success'>
			...
			<@boxHeader title='${anchor}</a>#i18n{portal.users.modify_attribute.listAssociatedFields}' boxTools=true>

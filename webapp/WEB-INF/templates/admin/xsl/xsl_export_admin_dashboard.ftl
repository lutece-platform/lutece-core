<#include "/admin/dashboard/admin/admindashboard_utils.ftl">
    ...
    <@table params='aria-describedby="manage_xsl_export"'>
        ...
        <thead>
					<tr>
						...
						<@th showXs=false>#i18n{portal.xsl.manage_xsl_export.row_description}</@th>
						<@th showXs=false>#i18n{portal.xsl.manage_xsl_export.row_extension}</@th>
        ...
        <#list xsl_export_list as xsl_export>
					<tr>
						...
						<@td showXs=false>${xsl_export.description}</@td>
						<@td showXs=false>${xsl_export.extension}</@td>
						<@td>
						<#if right_modify>

			...
			<@boxHeader title='#i18n{portal.mailinglist.modify_mailinglist.title}' />
			 <@boxBody>
				<@tform method='post' action='jsp/admin/mailinglist/DoModifyMailingList.jsp'>
					...
					<@formGroup rows=2>
						<@button type='submit' buttonIcon='pencil' title='#i18n{portal.mailinglist.modify_mailinglist.buttonModify}' size=''  />
					</@formGroup>
				</@tform>
			</@boxBody>
        </@box>
	...
	<@columns sm=8 md=9 lg=9>
		<@box color='success'>
			<@boxHeader title='#i18n{portal.mailinglist.view_users.boxTitle}' boxTools=true>
				<@tform align='right' method='get' action='jsp/admin/mailinglist/AddUsers.jsp'>
					<@input type='hidden' name='id_mailinglist' value='${mailinglist.id!}' />
					<@button type='submit' buttonIcon='plus' title='#i18n{portal.mailinglist.modify_mailinglist.buttonAddUsers}' size='sm' hideTitle=['xs','sm'] />
				</@tform>
				<@tform align='right' method='get' action='jsp/admin/mailinglist/ViewUsers.jsp'>
					<@input type='hidden' name='id_mailinglist' value='${mailinglist.id!}' />
					<@button type='submit' buttonIcon='eye' title='#i18n{portal.mailinglist.modify_mailinglist.buttonViewUsers}' size='sm' hideTitle=['xs','sm'] />
				</@tform>
			</@boxHeader>
			<@boxBody>
				<@table>
					...
					<tr>
						...
						<td>
							<@tform method='post' action='jsp/admin/mailinglist/DoDeleteFilter.jsp'>
								...
								<@input type='hidden' name='token' value='${token}' />
								<@aButton href='jsp/admin/mailinglist/ViewUsers.jsp?workgroup=${filter.workgroup}&amp;role=${filter.role}' buttonIcon='eye' title='#i18n{portal.mailinglist.modify_mailinglist.linkLabelViewUsers}' hideTitle=['all'] size='xs' />
								<@button type='submit' buttonIcon='trash' title='#i18n{portal.mailinglist.modify_mailinglist.linkLabelRemove}' hideTitle=['all'] color='danger' size='xs' />
							</@tform>
						</td>
					</tr>
					</#list>

...
--changeset core:update_db_lutece_core-7.9.9-8.0.0.sql
...
UPDATE core_admin_security_header SET value = 'default-src \'self\'; script-src \'self\' \'unsafe-inline\'; style-src \'self\' \'unsafe-inline\'; img-src \'self\' data: blob:; connect-src \'self\' blob:; object-src \'none\'; font-src \'self\' data:;form-action \'self\'; frame-ancestors \'self\'; upgrade-insecure-requests' WHERE name = 'Content-Security-Policy' AND type = 'page' AND value = 'default-src \'self\'; script-src \'self\' \'unsafe-inline\'; style-src \'self\' \'unsafe-inline\'; img-src \'self\' data: blob:; connect-src \'self\' blob:; object-src \'none\'; form-action \'self\'; frame-ancestors \'self\'; upgrade-insecure-requests';

DELETE FROM core_theme WHERE code_theme='lutece';
INSERT INTO core_theme VALUES ('lutece', 'Thème par Défaut pour les sites Lutece.', 'images/', 'css', 'Ville de Paris', 'https://lutece.paris.fr', '1.0', 'BSD', 'js/');
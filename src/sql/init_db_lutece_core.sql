...
INSERT INTO core_admin_right VALUES ('CORE_CACHE_MANAGEMENT', 'portal.system.adminFeature.cache_management.name', 0, 'jsp/admin/mvc/cache', 'portal.system.adminFeature.cache_management.description', 1, '', 'SYSTEM', 'ti ti-clock-edit', NULL, 1, 0);
INSERT INTO core_admin_right VALUES ('CORE_DAEMONS_MANAGEMENT', 'portal.system.adminFeature.daemons_management.name', 0, 'jsp/admin/mvc/daemons', 'portal.system.adminFeature.daemons_management.description', 0, '', 'SYSTEM', 'ti ti-timeline-event', NULL, 7, 0);
...
INSERT INTO core_admin_right VALUES ('CORE_MAILINGLISTS_MANAGEMENT', 'portal.mailinglist.adminFeature.mailinglists_management.name', 2, 'jsp/admin/mvc/mailinglists', 'portal.mailinglist.adminFeature.mailinglists_management.description', 0, '', 'MANAGERS', 'ti ti-mail-cog', NULL, 5, 0);
INSERT INTO core_admin_right VALUES ('CORE_PAGE_TEMPLATE_MANAGEMENT', 'portal.style.adminFeature.page_template_management.name', 0, 'jsp/admin/mvc/pagetemplates', 'portal.style.adminFeature.page_template_management.description', 0, '', 'STYLE', 'ti ti-layout-board', NULL, 1, 0);
INSERT INTO core_admin_right VALUES ('CORE_PLUGINS_MANAGEMENT', 'portal.system.adminFeature.plugins_management.name', 0, 'jsp/admin/mvc/plugins', 'portal.system.adminFeature.plugins_management.description', 1, '', 'SYSTEM', 'ti ti-apps-filled', NULL, 5, 0);
INSERT INTO core_admin_right VALUES ('CORE_PROPERTIES_MANAGEMENT', 'portal.site.adminFeature.properties_management.name', 2, 'jsp/admin/mvc/properties', 'portal.site.adminFeature.properties_management.description', 0, NULL, 'SITE', 'ti ti-checklist', 'jsp/admin/documentation/AdminDocumentation.jsp?doc=admin-properties', 2, 0);
INSERT INTO core_admin_right VALUES ('CORE_RBAC_MANAGEMENT', 'portal.rbac.adminFeature.rbac_management.name', 0, 'jsp/admin/mvc/rbac', 'portal.rbac.adminFeature.rbac_management.description', 0, '', 'MANAGERS', 'ti ti-user-check', NULL, 1, 0);
INSERT INTO core_admin_right VALUES ('CORE_RIGHT_MANAGEMENT', 'portal.users.adminFeature.right_management.name', 0, 'jsp/admin/mvc/rights', 'portal.users.adminFeature.right_management.description', 0, '', 'MANAGERS', 'ti ti-gavel', NULL, 6, 0);
INSERT INTO core_admin_right VALUES ('CORE_ROLES_MANAGEMENT', 'portal.role.adminFeature.roles_management.name', 2, 'jsp/admin/mvc/pagerole', 'portal.role.adminFeature.roles_management.description', 0, '', 'USERS', 'ti ti-list-check', NULL, 2, 0);
INSERT INTO core_admin_right VALUES ('CORE_SEARCH_INDEXATION', 'portal.search.adminFeature.indexer.name', 0, 'jsp/admin/mvc/searchindexation', 'portal.search.adminFeature.indexer.description', 0, '', 'SYSTEM', 'ti ti-settings-search', NULL, 2, 0);
...
INSERT INTO core_admin_right VALUES ('CORE_USERS_MANAGEMENT', 'portal.users.adminFeature.users_management.name', 2, 'jsp/admin/mvc/user', 'portal.users.adminFeature.users_management.description', 1, '', 'MANAGERS', 'ti ti-users', NULL, 2, 0);
INSERT INTO core_admin_right VALUES ('CORE_WORKGROUPS_MANAGEMENT', 'portal.workgroup.adminFeature.workgroups_management.name', 2, 'jsp/admin/mvc/workgroups', 'portal.workgroup.adminFeature.workgroups_management.description', 0, '', 'MANAGERS', 'ti ti-users-group', NULL, 3, 0);
INSERT INTO core_admin_right VALUES ('CORE_SECURITY_HEADER_MANAGEMENT', 'portal.system.adminFeature.security_header_management.name', 0, 'jsp/admin/mvc/securityheader', 'portal.system.adminFeature.security_header_management.description', 1, '', 'SYSTEM', 'ti ti-box-align-top', NULL, 12, 0);
INSERT INTO core_admin_right VALUES ('CORE_THEME_MANAGEMENT','portal.theme.adminFeature.theme_management.name',0,'jsp/admin/mvc/theme','portal.theme.adminFeature.theme_management.description',1,'','STYLE','ti ti-palette', NULL, 1, 0);
